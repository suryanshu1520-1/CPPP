...
export async function GET() {
  try {
    const response = await fetchR2Json('top_departments.json');
    // Ensure we limit to 15 for the main dashboard view
    ...
    console.error('Error fetching top departments from R2:', error);
    const mockDeps = [
